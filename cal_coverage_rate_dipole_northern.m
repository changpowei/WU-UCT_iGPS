function [coverage_rate] = cal_coverage_rate_northern(BS_lats, BS_lons)

    divide_decimal = 2;
    lat_bound1 = 24.30129; lat_bound2 = 25.29701;
    lon_bound1 = 120.9; lon_bound2 = 122.00862;

    % calculate area of the target area
    lats = lat_bound1:0.01:lat_bound2;
    lons = lon_bound1:0.01:lon_bound2;
    grid_area = length(lats)*length(lons);
    ...
    for j = 1:size(BS_lats, 2)
        ...
        txs_sinr = sinr(txs,'MaxRange',500e3, 'Resolution',1000);
